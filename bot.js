        ...
        if (user.pin === enteredPin) {
            ...
            if (result.success) {
                await db.query(
                    ...
                    [senderClean, plan.selling_price, plan.network_name, plan.plan_name, 'SUCCESS', 'WHATSAPP', result.provider, result.order_id]
                );
                ...
                await db.query(
                    ...
                    [senderClean, plan.selling_price, plan.network_name, plan.plan_name, 'FAILED', 'WHATSAPP']
                );
